    ...
    getBagButtons() {
        ...
        buttons.forEach(function (button) {
            ...
            button.addEventListener('click', function (e) {
                ...
                let cartItem = { ...Storage.getProduct(id), amount: 1 } //immutable add object
                // add product to the cart
                cart = [...cart, cartItem] //immutable add array
                // save cart in local storge
                Storage.saveCart(cart)
                // set cart values
                UI.setCartValues(cart)
                // لم يوافق على تنفيذ بالذيس وعملت ستاتيك بداله
                // display cart item
